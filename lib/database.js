    ...
    .insert([
      {
        ...
        installation_type: quoteData.installation_type || null,
        rolling: quoteData.rolling || null,
        // 保存四个独立的尺寸字段
        // 只存储用户实际输入的单位数据，不进行自动转换
        width_inch: quoteData.width_inch && quoteData.width_inch !== '' ? parseFloat(quoteData.width_inch) : null,
        width_m: quoteData.width_m && quoteData.width_m !== '' ? parseFloat(quoteData.width_m) : null,
        height_inch: quoteData.height_inch && quoteData.height_inch !== '' ? parseFloat(quoteData.height_inch) : null,
        height_m: quoteData.height_m && quoteData.height_m !== '' ? parseFloat(quoteData.height_m) : null,
