...
async function saveQuote(quoteData) {
  ...
  console.log('Database saveQuote - 单价计算:', {
    input_unitPrice: quoteData.unitPrice,
    input_totalPrice: quoteData.totalPrice,
    input_quantity: quoteData.quantity,
...
async function getQuoteDetails(quoteNumber) {
  ...
  console.log('getQuoteDetails called with quoteNumber:', quoteNumber);
  console.log('Supabase client created, making database query...');
  ...
  console.log('Returning data from getQuoteDetails:', data || []);
  return data || [];
}
